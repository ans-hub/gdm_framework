...
struct Shaders
{
  ...
  Shaders(Renderer& d3d)
    ...
    , nmap_sh_vx_{"shaders/nmap_vert.hlsl", layout_std_, d3d}
    , nmap_sh_px_{"shaders/nmap_frag.hlsl", sampler_std_, d3d}
  { }
...
struct Scene
{
  ...
  void LoadObjects(Renderer& d3d)
  {
    ...
    {
      DxObject object(d3d, obj_pathes[i].c_str());
  ...
  void LoadLamps(Renderer& d3d)
  {
    ...
    {
      DxObject object(d3d, lamp_pathes[i].c_str());
